...
type XRayRequestLog struct {
	...
	RequestURL      string     `bun:"request_url,type:text,notnull,default:''" json:"request_url"`
	...
	RequestHeaders  JSONObject `bun:"request_headers,type:jsonb,notnull,default:'{}'" json:"request_headers,omitempty"`
	RequestBody     string     `bun:"request_body,type:text,notnull,default:''" json:"request_body,omitempty"`
	ResponseHeaders JSONObject `bun:"response_headers,type:jsonb,notnull,default:'{}'" json:"response_headers,omitempty"`
	ResponseBody    string     `bun:"response_body,type:text,notnull,default:''" json:"response_body,omitempty"`
