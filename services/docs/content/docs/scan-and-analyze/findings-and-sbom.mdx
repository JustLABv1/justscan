...
See the [CVE Intelligence operator guide](/operate/vulnerability-intelligence) for the CVE Explorer, background worker, admin timeline, scheduling, progress telemetry, visibility rules, and troubleshooting. The scan-side model is summarized below.
