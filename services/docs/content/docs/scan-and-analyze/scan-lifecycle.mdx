...
For Xray's preparation, cache download, provider-wait, and import stages, see [Follow an Xray scan](/scan-and-analyze/registries-and-xray#follow-an-xray-scan). Provider waits release Xray preparation/import capacity and do not occupy local scanner workers.
