...
See the [CVE Intelligence operator guide](/operate/vulnerability-intelligence) for the background worker, admin timeline, scheduling, progress telemetry, and troubleshooting. The scan-side model is summarized below.
