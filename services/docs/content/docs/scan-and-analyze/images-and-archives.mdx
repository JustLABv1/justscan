...
Archives must be `.tar`, `.tar.gz`, or `.tgz` and can be up to 5 GiB. Use a pipeline-scoped organization token for unattended work; see [CLI profile and authentication](/integrations/cli#configure-a-profile).
