module github.com/JustNZ/JustWMS
...
require (
	...
	github.com/v1Flows/exFlow/services/backend v0.0.0-20250910110859-115734c2de76
)
...
require (
	...
	github.com/v1Flows/shared-library v1.0.25 // indirect
