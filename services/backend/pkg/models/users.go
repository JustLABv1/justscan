...
type Users struct {
	...
	LastLoginAt              *time.Time `bun:"last_login_at,type:timestamptz" json:"last_login_at,omitempty"`
	LastLoginMethod          string     `bun:"last_login_method,type:text,notnull,default:''" json:"last_login_method"`
	WorkspaceTourCompletedAt *time.Time `bun:"workspace_tour_completed_at,type:timestamptz" json:"workspace_tour_completed_at,omitempty"`
