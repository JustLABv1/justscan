                  ...
                  <div className="min-w-0 flex-1 space-y-3">
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        <p className="font-mono text-sm font-medium text-zinc-700 dark:text-zinc-200">
                          :{scan.image_tag}
                        </p>
                        <div className="mt-1.5 flex flex-wrap items-center gap-2">
                          ...
                          />
                          <span className="text-xs text-zinc-500" title={fullDate(scan.created_at)}>
                    ...
                    <div className="grid grid-cols-4 gap-2">
                      ...
                      >
                        <p className="text-[10px] uppercase tracking-[0.18em] text-orange-400/80">
                          H
                        </p>
                      ...
                      >
                        <p className="text-[10px] uppercase tracking-[0.18em] text-blue-400/80">
                          L
                        </p>
      ...
      {loading ? (
        ...
        <Table variant="secondary">
          <Table.ScrollContainer>
            <Table.Content aria-label={`Scans for ${imageName}`} className="min-w-[900px]">
              <Table.Header>
              ...
              <Table.Body>
                {scans.map((scan) => (
                  <Table.Row
                    key={scan.id}
                    id={scan.id}
                    className="cursor-pointer group transition-colors hover:bg-[rgba(124,58,237,0.06)]"
                  >
                    ...
                    <Table.Cell onClick={() => openScan(scan.id)}>
                    ...
                    <Table.Cell className="text-center" onClick={() => openScan(scan.id)}>
                      <SevCount count={scan.critical_count} level="critical" />
                    </Table.Cell>
                    <Table.Cell className="text-center" onClick={() => openScan(scan.id)}>
                      <SevCount count={scan.high_count} level="high" />
                    ...
                    <Table.Cell
                      ...
                      title={fullDate(scan.created_at)}
