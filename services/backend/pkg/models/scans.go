...
type BlockedPolicyDetails struct {
	...
	JFrog            string                      `json:"jfrog,omitempty"`
	MatchedIssues    []string                    `json:"matched_issues,omitempty"`
	MatchedWatches   []BlockedPolicyMatchedWatch `json:"matched_watches,omitempty"`
...
type BlockedPolicyMatchedWatch struct {
	Name             string `json:"name"`
	IgnoreRuleStatus string `json:"ignore_rule_status"`
}

type ScanComplianceSummary struct {
	Status            string                 `json:"status"`
	PassCount         int                    `json:"pass_count"`
	FailCount         int                    `json:"fail_count"`
	PolicyNames       []string               `json:"policy_names"`
	FailedPolicyNames []string               `json:"failed_policy_names"`
	FailedPolicies    []ScanCompliancePolicy `json:"failed_policies,omitempty"`
	EvaluatedAt       *time.Time             `json:"evaluated_at,omitempty"`
}

type ScanCompliancePolicy struct {
	Name          string   `json:"name"`
	RuleSummaries []string `json:"rule_summaries,omitempty"`
}
